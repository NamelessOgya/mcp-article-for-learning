...
async def main():
    ...
    server_params = StdioServerParameters(
        ...
        args=[os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "src", "mcp", "semantic_scholar_mcp.py")],
    )
    ...
    async with stdio_client(server_params) as (read, write):
        async with ClientSession(read, write) as session:
            ...
            # 4. LLMに指示を出す
            prompt = "Semantic Scholarを使って「Attention Is All You Need」という論文を検索し、それを引用している重要な論文を上位10件教えてください。"
